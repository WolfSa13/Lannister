...
COPY ./slack_interface/bonuses_orm_services.py ${LAMBDA_TASK_ROOT}
...
COPY ./slack_interface/requests_orm_services.py ${LAMBDA_TASK_ROOT}
...
COPY ./slack_interface/workers_orm_services.py ${LAMBDA_TASK_ROOT}
